 ...
 * 包自己引进来的东西反过来都要算（从前 `@ai-duel/design` 就在里面；正式版简化第 3 步
 * 把样式剥成素方块之后这个包不再引它了，第 5 步连它的 package.json 声明一起去掉）。
 *
 * ## 上限怎么定
 *
 ...
 *
 * 剥完样式实测只剩 1.28 KB。这个数**先不往下调**：重做视觉时样式会长回来，
 * 现在按这个数重定一次、过几周再抬回去，只是白改两遍。
 */
